...
public class WindowInStrategy implements InMethod {
	...
	//Accedemos al texto y vamos sustituyendo cada letra si se ejecuta una instruccion i,
	...
	private void loadText() throws IOException {
		...
		//Mientras que el metodo de FileIn no devuelva -1, seguimos guardando el texto.
		while (valor != -1) {
		...
		//Utilizamos un array de char auxiliar para tener la dimension exacta del texto
